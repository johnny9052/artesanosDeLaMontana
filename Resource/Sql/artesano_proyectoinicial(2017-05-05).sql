...
--
-- Host: localhost:3306
-- Generation Time: May 05, 2017 at 06:25 PM
...
-- Procedures
--
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listbeerin` (`iduser` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listbeerinventary` (`iduser` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listbeerproduct` (`iduser` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listbitter` (`iduser` INT)  BEGIN
   select id,nombre as 'nombre amargor',descripcion 
   from amargor
   order by nombre;
END$$

CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listcity` (`iduser` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listclient` (`iduser` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listdepartment` (`iduser` INT)  BEGIN
   select id,nombre as nombre_departamento,descripcion 
   from department
   order by nombre;
END$$

CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listexpense` (`idexpense` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listinventary` (`iduser` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listinventarytype` (`iduser` INT)  BEGIN
   select id,nombre as 'nombre tipo_inventario',descripcion 
   from tipo_inventario
   order by nombre;
END$$

CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listmessage` (`iduser` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listorder` (`iduser` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listrol` (`iduser` INT)  BEGIN
   select id,nombre as nombre_rol,descripcion 
   from rol
   order by nombre;
END$$

CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listspendtype` (`iduser` INT)  BEGIN
   select id,nombre as 'nombre tipo_gasto',descripcion 
   from tipo_gasto
   order by nombre;
END$$

CREATE DEFINER=`artesano`@`localhost` PROCEDURE `listuser` (`iduser` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loadallmenu` ()  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loadamargor` (`idfilter` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loadapage` (IN `vpage` VARCHAR(2000), IN `vrol` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loadbeertype` (`idfilter` INT)  BEGIN 
	IF idfilter > -1 THEN	
		select id,nombre
		from tipo_cerveza
		ORDER BY nombre;		
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loadbeertypestock` (`idfilter` INT)  BEGIN 
	IF idfilter > -1 THEN	
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loadcity` (`idfilter` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loadclienttype` (`idfilter` INT)  BEGIN 
	IF idfilter > -1 THEN	
		select id,nombre
		from tipo_cliente
		ORDER BY nombre;		
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loaddepartment` (`idfilter` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loadexpensetype` (`idfilter` INT)  BEGIN 
	IF idfilter > -1 THEN	
		select id,nombre
		from tipo_gasto
		ORDER BY nombre;		
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loadmenu` (IN `rol` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loadrol` (IN `idfilter` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loadtypeinventary` (`idfilter` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `login` (`usu` VARCHAR(50), `pass` VARCHAR(50))  BEGIN
   select usuario,primer_nombre,primer_apellido,rol,id from usuario where password=pass and usuario=usu;		
END$$

CREATE DEFINER=`artesano`@`localhost` PROCEDURE `loginpublic` (`usu` VARCHAR(50), `pass` VARCHAR(32))  BEGIN
   select id,nombre,email,direccion from cliente where password=pass and code=usu;		
END$$

CREATE DEFINER=`artesano`@`localhost` PROCEDURE `reportexpense` (`iduser` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `reportorder` (`iduser` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchbeerin` (`idbeerin` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchbeerproduct` (`idbeerproduct` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchbitter` (`idbitter` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchcity` (`vid` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchclient` (`idclient` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchdepartment` (`iddepartment` INT)  BEGIN 	
	select id,nombre,descripcion
	from department
	where id = iddepartment;	
END$$

CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchexpense` (`idexpense` INT)  BEGIN 	
	select id,id_tipo_gasto,observaciones,valor,fecha
	from gasto
	where id = idexpense;
END$$

CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchinventary` (`idinventary` INT)  BEGIN 
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchinventarytype` (`idinventarytype` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchmessage` (`vid` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchorder` (`vid` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchorderproduct` (`vid` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchrol` (`idrol` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchspendtype` (`idspendtype` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `searchuser` (`vid` INT)  BEGIN
...
CREATE DEFINER=`artesano`@`localhost` PROCEDURE `validateclient` (`idfilter` INT)  BEGIN 		
...
-- Functions
--
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deletebeerin` (`cod` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deletebeerproduct` (`vid` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deletebitter` (`cod` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deletecity` (`vid` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deleteclient` (`cod` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deletedepartment` (`cod` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deleteexpense` (`cod` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deleteinventary` (`vid` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deleteinventarytype` (`cod` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deletemessage` (`vid` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deleteorder` (`vid` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deleterol` (`cod` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deletespendtype` (`cod` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `deleteuser` (`vid` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `orderupdatestate` (`vid` INT, `vestado` INT, `vdescripcionadmin` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `savebeerin` (`vid` INT, `vBeerType` INT, `vBootle` INT, `vPresentation` VARCHAR(50), `vLote` VARCHAR(50), `vDateMosto` DATE, `vDateGasificacion` DATE, `vDescription` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `savebeerproduct` (`id` INT, `vname` VARCHAR(50), `vdescription` VARCHAR(2000), `valcohol` DOUBLE, `vamargor` INT, `vvalor` DOUBLE, `vcantidad` DOUBLE) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `savebitter` (`cod` INT, `nom` VARCHAR(50), `des` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `savecity` (`id` INT, `vname` VARCHAR(50), `vdepartment` INT, `vdescription` VARCHAR(50)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `saveclient` (`vid` INT, `vTypeClient` INT, `vName` VARCHAR(50), `vCode` VARCHAR(50), `vEmail` VARCHAR(50), `vAddress` VARCHAR(50), `vPhonenumber` VARCHAR(50), `vDescription` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `saveclientregister` (`vid` INT, `vTypeClient` INT, `vName` VARCHAR(50), `vCode` VARCHAR(50), `vEmail` VARCHAR(50), `vAddress` VARCHAR(50), `vPhonenumber` VARCHAR(50), `vPassword` VARCHAR(32)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `savedepartment` (`cod` INT, `nom` VARCHAR(50), `des` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
    COMMENT 'Funcion que almacena un departamento'
BEGIN 
    DECLARE res INT DEFAULT 0;
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `saveexpense` (`vid` INT, `vTypeexpense` INT, `vDescription` VARCHAR(2000), `vValue` DOUBLE, `vDateExpense` DATE) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `saveinventary` (`vid` INT, `vname` VARCHAR(50), `vcode` VARCHAR(50), `vdate` DATE, `vvalor` DOUBLE, `vtype` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `saveinventarytype` (`cod` INT, `nom` VARCHAR(50), `des` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `saveorder` (`vidcliente` INTEGER, `vdireccion` VARCHAR(50), `vidciudad` INTEGER, `vdescripcion` VARCHAR(2000), `vproducts` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `savepublicmessage` (`nom` VARCHAR(50), `email` VARCHAR(50), `des` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `saverol` (`cod` INT, `nom` VARCHAR(50), `des` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `savespendtype` (`cod` INT, `nom` VARCHAR(50), `des` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `saveuser` (`id` INT, `vfirstname` VARCHAR(50), `vsecondname` VARCHAR(50), `vfirstlastname` VARCHAR(50), `vsecondlastname` VARCHAR(50), `vuser` VARCHAR(50), `vpass` VARCHAR(50), `vrol` INT, `vdescription` VARCHAR(50)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
    COMMENT 'Funcion que almacena un rol'
BEGIN 
    DECLARE res INT DEFAULT 0;
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updatebeerin` (`vid` INT, `vBeerType` INT, `vBootle` INT, `vPresentation` VARCHAR(50), `vLote` VARCHAR(50), `vDateMosto` DATE, `vDateGasificacion` DATE, `vDescription` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updatebeerproduct` (`vid` INT, `vname` VARCHAR(50), `vdescription` VARCHAR(2000), `valcohol` DOUBLE, `vamargor` INT, `vvalor` DOUBLE, `vcantidad` DOUBLE) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updatebitter` (`cod` INT, `nom` VARCHAR(50), `des` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updatecity` (`vid` INT, `vname` VARCHAR(50), `vdepartment` INT, `vdescription` VARCHAR(50)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updateclient` (`vid` INT, `vTypeClient` INT, `vName` VARCHAR(50), `vCode` VARCHAR(50), `vEmail` VARCHAR(50), `vAddress` VARCHAR(50), `vPhonenumber` VARCHAR(50), `vDescription` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updatedepartment` (`cod` INT, `nom` VARCHAR(50), `des` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updateexpense` (`vid` INT, `vTypeexpense` INT, `vDescription` VARCHAR(2000), `vValue` DOUBLE, `vDateExpense` DATE) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
    COMMENT 'Funcion que modifica un cliente'
BEGIN 
    DECLARE res INT DEFAULT 0;
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updateinventary` (`vid` INT, `vname` VARCHAR(50), `vcode` VARCHAR(50), `vdate` DATE, `vvalor` DOUBLE, `vtype` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updateinventarytype` (`cod` INT, `nom` VARCHAR(50), `des` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updatemessage` (`cod` INT, `resp` VARCHAR(2000), `est` INT) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updatepermission` (`vid` INTEGER, `vpermission` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updaterol` (`cod` INT, `nom` VARCHAR(50), `des` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updatespendtype` (`cod` INT, `nom` VARCHAR(50), `des` VARCHAR(2000)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
...
CREATE DEFINER=`artesano`@`localhost` FUNCTION `updateuser` (`vid` INT, `vfirstname` VARCHAR(50), `vsecondname` VARCHAR(50), `vfirstlastname` VARCHAR(50), `vsecondlastname` VARCHAR(50), `vuser` VARCHAR(50), `vpass` VARCHAR(50), `vrol` INT, `vdescription` VARCHAR(50)) RETURNS INT(1) READS SQL DATA
    DETERMINISTIC
    COMMENT 'Funcion que modifica un rol'
BEGIN 
    DECLARE res INT DEFAULT 0;
...
(71, 2, 'Hielo para enfriamiento de mosto', 15000, '2017-03-28'),
(72, 2, 'Hielo enfriamiento mosto', 15000, '2017-03-31');
...
(34, 'AndrÃ©s Cardona ', 'afcardon@gmail.com', 'Buenos dÃ­as, donde puedo comprar unas botellas en Pereira. EstarÃ© de viaje y me gustarÃ­a comprar unas cuantas. Muchas gracias ', 'Muy buen dÃ­a amigo cervecero, por ahora se consiguen algunas unidades en Camden Town, digo algunas ya que aÃºn estamos en proceso para adquirir el registro invima y limitamos nuestras ventas para no entrar en conflictos con el estado. O a travÃ©s de facebook nos puede contactar para ponernos de acuerdo y concretar una venta directa con nosotros.', b'1');
...
CREATE TABLE `pedido` (
  ...
  `estado` bit(1) DEFAULT NULL,
  `descripcion` varchar(2000) DEFAULT NULL,
  `descripcion_administracion` varchar(2000) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `pedido` (`id`, `idcliente`, `fechapedido`, `direccion`, `idciudad`, `estado`, `descripcion`, `descripcion_administracion`) VALUES
(46, 10, '2017-02-08', 'CRA 13 #2e 04 la aurora bloque 9 apto 304', 1, b'1', NULL, NULL),
(45, 8, '2017-02-06', 'Cr 22 # 24-54 Mz 1 Cs 22', 1, b'1', NULL, NULL),
(76, 7, '2017-03-04', 'Claro 17 No 4-58', 1, b'1', '', NULL),
(51, 9, '2017-02-11', 'Calle17#4-58', 1, b'1', NULL, NULL),
(49, 11, '2017-02-08', 'Loma linda dosquebradas', 1, b'1', NULL, ''),
(50, 12, '2017-02-08', 'Calle 17#4-58', 1, b'1', NULL, NULL),
(53, 9, '2017-02-12', 'Calle17#4-58', 1, b'1', NULL, NULL),
(58, 10, '2017-02-14', 'CRA 13 #2e 04 la aurora bloque 9 apto 304', 1, b'1', NULL, NULL),
(55, 12, '2017-02-13', 'Calle 17#4-58', 1, b'1', NULL, NULL),
(62, 9, '2017-02-22', 'Calle17#4-58', 1, b'1', NULL, ''),
(57, 9, '2017-02-14', 'Calle17#4-58', 1, b'1', NULL, ''),
(59, 13, '2017-02-15', 'Cra 15 bis # 10b-40 apartamento 402', 1, b'1', NULL, NULL),
(60, 13, '2017-02-19', 'Bulevar de las Villas m8 c 13', 1, b'1', NULL, NULL),
(61, 9, '2017-02-19', 'Calle17#4-58', 1, b'1', NULL, ''),
(63, 9, '2017-02-22', 'Calle17#4-58', 1, b'1', NULL, NULL),
(64, 9, '2017-02-22', 'Calle17#4-58', 1, b'1', NULL, NULL),
(74, 9, '2017-03-04', 'Calle17#4-58', 1, b'1', 'PEDIDO ENTREGADO EL 28 DE FEBRERO A ALEJANDRO MONSALVE, PEDIDO A TRAVES DE INSTAGRAM', NULL),
(66, 9, '2017-02-23', 'Calle17#4-58', 1, b'1', NULL, ''),
(67, 9, '2017-02-23', 'Calle17#4-58', 1, b'1', NULL, NULL),
(71, 10, '2017-02-28', 'CRA 13 #2e 04 la aurora bloque 9 apto 304', 1, b'1', '', NULL),
(72, 14, '2017-02-28', 'cll 11 # 12b - 20', 1, b'1', '', NULL),
(73, 15, '2017-03-03', 'Car5#18-33', 1, b'1', '', NULL),
(75, 9, '2017-03-04', 'Calle17#4-58', 1, b'1', 'PARA SEBASTIAN, SE ENTREGO EL 18 DE FEBRERO', NULL),
(78, 12, '2017-03-04', 'Calle 17#4-58', 1, b'1', 'SÃ³lo se ha cancelado una.', 'CANCELADAS MARZO 25'),
(79, 9, '2017-03-04', 'Calle17#4-58', 1, b'1', 'PizzerÃ­a a la rÃºstica pizza al horno', NULL),
(80, 9, '2017-03-04', 'Calle17#4-58', 1, b'0', 'Elias Naranjo', NULL),
(81, 14, '2017-03-05', 'cll 11 # 12b - 20', 1, b'1', '', NULL),
(82, 10, '2017-03-05', 'CRA 13 #2e 04 la aurora bloque 9 apto 304', 1, b'1', '', NULL),
(83, 12, '2017-03-06', 'Calle 17#4-58', 1, b'1', '', NULL),
(84, 13, '2017-03-07', 'Bulevar de las Villas m8 c 13', 1, b'1', 'CPC y otro', ''),
(85, 9, '2017-03-07', 'Calle17#4-58', 1, b'1', 'Tres muestras a cambio de apoyo tÃ©cnico en el diseÃ±o y fabricaciÃ³n de los sistemas de enfriamiento ', ''),
(86, 9, '2017-03-07', 'Calle17#4-58', 1, b'1', 'Muestras para RagnarÃ¶k, afianzamiento de relaciones comerciales', ''),
(94, 8, '2017-03-09', 'Cr 22 # 24-54 Mz 1 Cs 22', 1, b'1', '', NULL),
(95, 7, '2017-03-12', 'Claro 17 No 4-58', 1, b'1', '', NULL),
(96, 13, '2017-03-12', 'Bulevar de las Villas m8 c 13', 1, b'1', '', ''),
(97, 17, '2017-03-14', 'calle 22 # 18-08 barrio providencia', 1, b'1', 'telefono 3103567485 horario de 8 a 5', NULL),
(98, 8, '2017-03-14', 'Cr 22 # 24-54 Mz 1 Cs 22', 1, b'1', '', NULL),
(99, 13, '2017-03-15', 'Bulevar de las Villas m8 c 13', 1, b'1', '', NULL),
(100, 13, '2017-03-16', 'Bulevar de las Villas m8 c 13', 1, b'1', '', ''),
(101, 12, '2017-03-16', 'Calle 17#4-58', 1, b'1', 'Pedido para Erwin Tamayo', ''),
(102, 9, '2017-03-16', 'Calle17#4-58', 1, b'1', 'Pizzeria a la rustica', NULL),
(103, 13, '2017-03-17', 'Bulevar de las Villas m8 c 13', 1, b'1', '5 sixpack ', 'ENTREGADO MARZO 24'),
(104, 9, '2017-03-17', 'Calle17#4-58', 1, b'1', 'Julio Pizzeria ', ''),
(105, 12, '2017-03-19', 'Calle 17#4-58', 1, b'0', 'Pedida por Jose Espitia', ''),
(107, 9, '2017-03-21', 'Calle17#4-58', 1, b'1', 'Para Ricardo Orosco', 'Valor venta $20000'),
(110, 9, '2017-03-23', 'Calle17#4-58', 1, b'0', 'Pizzeria a la rÃºstica ', NULL),
(112, 9, '2017-03-24', 'Calle17#4-58', 1, b'1', '', ''),
(113, 13, '2017-03-27', 'Bulevar de las Villas m8 c 13', 1, b'0', '', NULL),
(114, 9, '2017-03-27', 'Calle17#4-58', 1, b'0', 'Laura y Carolina Kalu', NULL),
(115, 9, '2017-03-29', 'Calle17#4-58', 1, b'0', '', 'Adriana Ochoa la mama de ana probiota'),
(116, 9, '2017-03-29', 'Calle17#4-58', 1, b'0', '3 cumanday para completar el pedido de Sebastian', NULL);
...
--
-- Indexes for table `entrada_cerveza`
--
ALTER TABLE `entrada_cerveza`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_tipo_cerveva` (`id_tipo_cerveva`);
...
--
-- Indexes for table `tipo_cerveza`
--
ALTER TABLE `tipo_cerveza`
  ADD PRIMARY KEY (`id`),
  ADD KEY `amargor` (`amargor`);
...
--
-- AUTO_INCREMENT for table `amargor`
--
ALTER TABLE `amargor`
...
ALTER TABLE `department`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `entrada_cerveza`
--
ALTER TABLE `entrada_cerveza`
...
--
-- AUTO_INCREMENT for table `tipo_cerveza`
--
ALTER TABLE `tipo_cerveza`
